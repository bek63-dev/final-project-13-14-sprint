// Package domain: файл repeat_rule.go содержит разбор строки repeat на тип правила и его
// аргументы, а также вспомогательный парсинг списков чисел через запятую.
package domain
